...
namespace Lypi
{
	...
	//	m_iSRegion.left	   = center.x - m_HarpWidth;
	//	m_iSRegion.top     = center.y - m_HarpHeight;
	//	m_iSRegion.right   = center.x + m_HarpWidth;
	//	m_iSRegion.bottom  = center.y + m_HarpHeight;

	//	//계산상 이게 맞음.
	//	m_fPRegion.left    = ( (m_iSRegion.left   / (float)g_rtClient.right)  *  2.0f - 1.0f);
	//	m_fPRegion.top     = ( (m_iSRegion.top    / (float)g_rtClient.bottom) *  2.0f - 1.0f); 
	//	m_fPRegion.right   = ( (m_iSRegion.right  / (float)g_rtClient.right)  *  2.0f - 1.0f);
	//	m_fPRegion.bottom  = ( (m_iSRegion.bottom / (float)g_rtClient.bottom) *  2.0f - 1.0f); 
	...
	//	if (FAILED(hr = g_pD3dDevice->CreateSamplerState(&SamplerDesc, &m_pSampler)))
	//	{
	//		return hr;
	//	}
	...
	//	if (FAILED(hr = g_pD3dDevice->CreateRasterizerState(&RasterDesc, &m_pRaster)))
	//	{
	//		return hr;
	//	}
	...
	//	g_pD3dContext->RSSetState(m_pRaster);
	//	g_pD3dContext->VSSetSamplers(0, 1, &m_pSampler);
	//	g_pD3dContext->GSSetSamplers(0, 1, &m_pSampler);
	//	g_pD3dContext->PSSetSamplers(0, 1, &m_pSampler);
