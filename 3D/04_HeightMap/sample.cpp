...
bool Sample::Init()
{
	...
	MapDesc Mdesc = { 16, 16, 1.0f, 0.5f, L"../../INPUT/DATA/shader/vs.hlsl", L"../../INPUT/DATA/shader/ps.hlsl", L"NULL", L"../../INPUT/DATA/image/defalut.bmp" };
	m_Map.CreateHeightMap(L"../../INPUT/DATA/image/defalut_height.bmp");
