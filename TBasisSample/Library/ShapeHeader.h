...
{
	// Sub texture types
#define TexType_AM 0   // ambient
#define TexType_DI 1   // diffuse
#define TexType_SP 2   // specular
#define TexType_SH 3   // shininesNs
#define TexType_SS 4   // shininess strength
#define TexType_SI 5   // self-illumination
#define TexType_OP 6   // opacity
#define TexType_FI 7   // filter color
#define TexType_BU 8   // bump 
#define TexType_RL 9   // reflection
#define TexType_RR 10  // refraction 
#define TexType_DP 11  // displacement
#define TexType_GN 12  // Generic
#define TexType_EV 13  // EnvMap
